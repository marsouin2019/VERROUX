    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            // include connexion et requete selecte
            include("../class/connect.php");

            $idpersonne = $_GET["id"];


            $req = $mysqli->query("SELECT * FROM inscription WHERE id = '".$idpersonne."' ");
            $row = $req->fetch_assoc();
            ...
            <form action="" method="post" >
                <div class="form-group">
                    <label for="">nom</label>
                    <input type="text" class="form-control" id="" value="<?php echo $row["nom"] ?>" name="frmNom">
                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                </div>
                <div class="form-group">
                    <label for="">prenom</label>
                    <input type="text" class="form-control" id="" value="<?php echo "" ?>" name="frmPrenom">
                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                </div>
            ...
            <button type="submit" class="btn btn-primary" name="frmForm" value="frmUpdate">MISE A JOUR </button>
            </form>
